...
Included notebooks test out this model first on a Mackey–Glass chaotic time series and S&P 100 equities, but the real 
endpoint is a benchmark of this models performance against a State-Of-The-Art risk estimation model called 
DeepVaR (Fatouros et al., 2023) based on a FOREX dataset. Our direct comparison with DeepVaR demonstrates that 
BCPNN-LTSL enables a veryfast and compute efficient prediction of Value-At-Risk 
without sacrificing performance against the state-of-the-art.
